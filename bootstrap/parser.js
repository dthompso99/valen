...
export class Parser {
    ...
    parseObject(visibility = 'public') {
        ...
        if (this.match('LESS')) {
            do {
                typeParameters.push(this.consume('IDENTIFIER', 'Expected a type parameter name').value);
                typeConstraints.push(this.match('COLON') ? this.parseTypeReference() : null);
