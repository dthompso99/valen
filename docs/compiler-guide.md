...
- The initial generation-0 AArch64 backend emits and directly encodes a deliberately restricted
  ...
  concatenation, copied byte slicing, copied conversion between strings and `Array<u8>`, and validated
  UTF-8 code-point length/index operations. It is the cross-compilation foothold for the full runtime and
